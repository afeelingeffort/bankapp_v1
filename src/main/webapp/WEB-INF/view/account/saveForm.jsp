	...
	<div class="bg-light p-md-5 h-75 align-items-center justify-content-center">
		<form action="/account/save-proc" method="post">
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="생성 계좌번호 입력" id="number" name="number" value="5555">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="입금 금액을 입력하시오" id="balance" name="balance" value="2000">
			</div>
