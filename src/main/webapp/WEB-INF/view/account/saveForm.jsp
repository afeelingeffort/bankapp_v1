...
<div class="col-sm-8">
	<h2>계좌 생성 페이지(인증한 사람만 들어올 수 있음.)</h2>
	<h5>어서오세요 환영합니다.</h5>
	...
	<div class="bg-light p-md-5 h-75 align-items-center justify-content-center">
		<form action="#" method="post">
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="생성 계좌번호 입력" id="number" name="number">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="입금 금액을 입력하시오" id="balance" name="balance">
			</div>
