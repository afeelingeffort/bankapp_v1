...
<div class="col-sm-8">
	...
	<div class="bg-light p-md-5 h-75">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=703be5f1b34a04e58737e1be072825fc&redirect_uri=http://localhost:8080/auth/kakao/callback&response_type=code"><img alt="" src="/images/kakao_login_medium.png" style="margin-top: 10px; width: 75; height: 40;"></a>
	</div>
	<br>
</div>
